...
const AllOrder = () => {
    ...
    return (
      <div className='h-[calc(100vh-190px)] bg-white-600 overflow-y-scroll'>
        {
          !data[0] && (
            <p>No Order Found</p>
          )
       ...
       <div className='p-4 w-full'>
        {
          data.map((item,index)=>{
           ...
           <div className='grid gap-1'>
                ...
                <div>
                  <div className='tex-lg font-medium'>Payment Details : </div>
                  <p className=' ml-1'>Payment method : {item.paymentDetails.payment_method_type[0]}</p>
                  <p className=' m-1'>Payment Status : {item.paymentDetails.payment_status}</p>
                </div>
                <div >
                  <div className='tex-lg font-medium'>Shipping Details : </div>
                  {
                ...
                <div className='font-semibold ml-auto w-fit lg:text-lg '>Total Amount : {item.totalAmount}
