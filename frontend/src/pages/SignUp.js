 ...
 setData((preve)=>{
  ...
  const handleSubmit = async(e)=>{
      ...
      if(data.password === data.confirmPassword){
        ...
        toast.error("Please check password and confrim password");
  ...
  Upload Photo
        ...
        <div className="grid mb-4">
          ...
          <button  className='px-3 py-1 hover:bg-purple-700 rounded-full text-white bg-yellow-600 hover:scale-110 transition-all mx-auto block mt-4'>Sign Up</button>
        </form>
