    ...
    <div className='container mx-auto p-4'>
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
        ...
        <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2'>         
          ...
          <div className='w-full h-full min-h-[400px] min-w-[500px]  mix-blend-multiply scale-150' style={{backgroundImage :`url(${activeImage})`,
             ...
             <div className='flex gap-2 lg:flex-col overflow-scroll scrollbar-none h-full'> 
              ...
              <div className='flex gap-2 lg:flex-col overflow-scroll scrollbar-none h-full'> 
              {
                 data?.productImage?.map((imageURL,index) =>{
                  return(
                    <div className='h-20 w-20 bg-slate-200 rounded p-2' key={imageURL}>
        ...
        {/**product Details */}
        {
         ...
         <p className='bg-slate-200 h-6 lg:h-8 w-full rounded-full capitalize inline-block '></p>
       ...
       <p className='capitalize text-slate-400 bg-slate-200 min-w-[100px] animate-pulse h-6 w-full lg:h-8 '></p>
        ...
        <div className='w-full'>
          ...
          <p className='h-10 bg-slate-200 rounded animate-pulse w-full lg:h-12'></p>
            ...
            <p className='bg-red-200 text-red-600 px-2 rounded-full capitalize inline-block w-fit'>{data?.brandName}</p>
...
{
  data.category && (
    <CategoryWiseProductDisplay category={data?.category} heading={"Recomended Produts"}/>
