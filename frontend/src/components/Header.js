      ...
      <Logo w={90} h ={50} />
        ...
        </div>
       {
        ...
        <div>
          ...
          {
            user?._id ? (
              <button onClick={handleLogout} className='px-3 py-1 rounded-full text-white bg-yellow-600 hover:bg-purple-700'>Logout</button>
            ) : (
              <Link to={"/login"} className='px-3 py-1 rounded-full text-white bg-yellow-600 hover:bg-purple-700'>LogIn</Link>
              )
          }
        </div>
