              ...
              <FaAngleRight /></button>
       {
            loading ? (
                ...
                <div className='p-4 grid w-full gap-2'>
                        <h2 className='font-medium text-base md:text-lg text-ellipsis line-clamp-1 text-black bg-slate-200 py-2 animate-pulse p-1 rounded-full'></h2>
                    ...
                    <button className=' text-sm text-white px-3  rounded-full w-full bg-slate-200 animate-pulse p-1  py-2 '></button>
                </div>
            </div>
                    )
                })
                ...
                <div className='p-4 grid'>
                    ...
                    >{displayINRCurrency(product.sellingPrice) }</p>
                    <p className='text-slate-500 line-through'
                     style={{ maxWidth: '150px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}
                    >{displayINRCurrency(product.price)}</p>
                        </div>
                    <button className=' text-sm bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-0.5 rounded-full' 
